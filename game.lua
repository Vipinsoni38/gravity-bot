...
back=display.newImage("back.png")
back.width=3500
back.height=3500
...
p_options = 
	...
	hero.y = 580
	hero:play()
platmain=display.newImage("platmain.png",_W/2,600)
physics.addBody(platmain,"static")
sceneGroup:insert(platmain)
...
temp=display.newImage("tempblack.png",_W/2,_H-200)
...
function restart( ... )
	...
	composer.gotoScene("restart","fade",300)
audio.play(onclick)
end
